...
selection = Sprite(".//Sprites//full.png", 247, 322, 1, 1, [250, 250], 1)
...
def drawSpriteSheet(canvas):
    ...
    Sprite(previewSprites[cursor1.previewSelection()], 210, 52, 2, 14, (50, 250), 8).draw(canvas)
    Sprite(previewSprites[cursor2.previewSelection()], 210, 52, 2, 14, (450, 250), 8).draw(canvas)
